    ...
    return (
        <Base1>
            ...
            <ul className="grid grid-cols-1 gap-2" style={{ display: 'flex', justifyContent: 'flex-end', float: 'left', margin: 20, padding: 10 }} >
                ...
                <div>
                    <iframe style={{ justifyContent: 'center', margin: ' auto', marginTop: '10px' }} width="720" height="100%" src="https://www.youtube.com/embed/hCLzfcyteq0" title="Música Prehispánica | Jorge Reyes" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
