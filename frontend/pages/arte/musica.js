...
const Musica=()=>{
    ...
    return(
        ...
        <h3 style={{ fontSize: '40px', fontWeight: 'normal',marginLeft:'125px',marginTop: '10px', marginRight: '125px', color: '#000' }}>Tipos de musica</h3>
        <p style={{textAlign:'justify', fontSize: '23px', fontWeight: 'normal',marginLeft:'125px',marginTop: '10px', marginRight: '125px', color: '#000' }} >
        ...
        <h3 style={{ fontSize: '40px', fontWeight: 'normal',marginLeft:'125px',marginTop: '10px', marginRight: '125px', color: '#000' }}>Características de la Música Azteca</h3>
        <p style={{textAlign:'justify', fontSize: '23px', fontWeight: 'normal',marginLeft:'125px',marginTop: '10px', marginRight: '125px', color: '#000' }} >
        ...
        <h3 style={{ fontSize: '40px', fontWeight: 'normal',marginLeft:'125px',marginTop: '10px', marginRight: '125px', color: '#000' }}> La musica en la vida diaria de los aztecas</h3>
        <p style={{textAlign:'justify',marginBottom: '125px', fontSize: '23px', fontWeight: 'normal',marginLeft:'125px',marginTop: '10px', marginRight: '125px', color: '#000' }} >
